  ...
  <div className="container p-res">
    <div className="row">
      ...
      <MediaQuery maxDeviceWidth={799}>
        <div className="mobile-heading-box descender">
    ...
    <div className="content-box mt-5">
      <div className="invisible-content-box">
        <div>
          ...
          <p>We implement a variety of security measures when a user enters, submits, or accesses their information to maintain the
          ...
          <p>
            ...
            us to provide you with improved services. We also use cookies to help us compile aggregate data about site traffic and
          ...
          <h5>Google</h5>
          <p>
            Google&apos;s advertising requirements can be summed up by <a href="https://support.google.com/adwordspolicy/answer/1316548?hl=en">Google&apos;s Advertising Principles</a>. They are put in place to provide
          ...
          <p>We do not let third-parties, including ad networks or plug-ins collect PII from children under 13.</p>
          ...
          <h5>CAN SPAM Act</h5>
          <p>The CAN-SPAM Act is a law that sets the rules for commercial email, establishes requirements for commercial messages, gives
          ...
          <p>
            <strong>
              If at any time you would like to unsubscribe from receiving future emails, you can email us at <a href="mailto:harvey@operationspark.org">harvey@operationspark.org</a>.
            </strong>
          </p>
          <p>
        ...
        <p>
          ...
          United States <br />
          <a href="mailto:max@operationspark.org">max@operationspark.com</a> <br />
        </p>
        <br />
        <p>
          <i>Last Edited on March 23, 2018.</i>
        </p>
      </div>
    </div>
  </div>
