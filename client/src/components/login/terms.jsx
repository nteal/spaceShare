  ...
  <div className="container p-res">
    ...
    <div className="content-box mt-5">
      <div className="invisible-content-box">
        <p>
          <i>Effective as of March 28, 2018</i>
        </p>
        <p>
          Welcome to the SpaceShare Terms of Use agreement. For purposes of this agreement, “Site” refers to the Company’s website, which can be accessed at spaceshare.co or through our mobile application. “Service” refers to the Company’s services accessed via the Site, in which users can connect with other users to find spaces for rent. The terms “we,” “us,” and “our” refer to the Company. “You” refers to you, as a user of our Site or our Service. 

          The following Terms of Use apply when you view or use the Service via our website located at spaceshare.co or by accessing the Service through clicking on the application (the “App”) on your mobile device.  
        ...
        <p>
          The Company respects the privacy of its Service users. Please refer to the Company’s Privacy Policy (found here: spaceshare.co/privacy-policy) which explains how we collect, use, and disclose information that pertains to your privacy. When you access or use the Service, you signify your agreement to the Privacy Policy as well as these Terms of Use.
        </p>
        <h4>
          ABOUT THE SERVICE
        </h4>
        <p>
          The Service allows you to communicate with other users regarding spaces for rent.  
        </p>
        <h4>
        ...
        <p>
          When you create your own personalized account, you may be able to provide your email address, location, and other information (“User Content”) to the Service. You are solely responsible for the User Content that you post, upload, link to or otherwise make available via the Service. 
        ...
        <p>
          (b) DMCA Take-Down Notices.  If you are a copyright owner or an agent thereof and believe, in good faith, that any materials provided on the Service infringe upon your copyrights, you may submit a notification pursuant to the Digital Millennium Copyright Act (see 17 U.S.C 512) (“DMCA”) by sending the following information in writing to the our designated copyright agent at <a href="mailto:harvey@operationspark.org">harvey@operationspark.org</a>:
        </p>
        <ol>
          <li>
        ...
        <ol>
          ...
          <li>
            Your name, address, telephone number, and email address, a statement that you consent to the jurisdiction of the federal court in Louisiana and a statement that you will accept service of process from the person who provided notification of the alleged infringement.
          </li>
        </ol>
        <p>
        ...
        <p>
          We may also use your email address to send you other messages, including information about the Site or the Service and special offers. You may opt out of such email by changing your account settings, using the “Unsubscribe” link in the message, or by sending an email to <a href="mailto:selena@operationspark.org">selena@operationspark.org</a> or mail to the following postal address:
          <br />
          <br />
          SpaceShare Customer Support
          <br />
          748 Camp Street
          <br />
          Suite 2
        ...
        <p>
          These Terms of Use and your use of the Site are governed by the federal laws of the United States of America and the laws of the State of Louisiana, without regard to conflict of law provisions.
        </p>
        <p>
          We may assign or delegate these Terms of Service and/or our Privacy Policy, in whole or in part, to any person or entity at any time with or without your consent. You may not assign or delegate any rights or obligations under the Terms of Service or Privacy Policy without our prior written consent, and any unauthorized assignment or delegation by you is void.
        </p>
        <p>
          YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF USE, UNDERSTAND THE TERMS OF USE, AND WILL BE BOUND BY THESE TERMS AND CONDITIONS. YOU FURTHER ACKNOWLEDGE THAT THESE TERMS OF USE TOGETHER WITH THE PRIVACY POLICY AT SPACESHARE.CO/PRIVACY-POLICY REPRESENT THE COMPLETE AND EXCLUSIVE STATEMENT OF THE AGREEMENT BETWEEN US AND THAT IT SUPERSEDES ANY PROPOSAL OR PRIOR AGREEMENT ORAL OR WRITTEN, AND ANY OTHER COMMUNICATIONS BETWEEN US RELATING TO THE SUBJECT MATTER OF THIS AGREEMENT.
        </p>
      </div>
    </div>
  </div>
